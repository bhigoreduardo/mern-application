...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`w-full hidden md:block border border-gray-100 bg-white rounded-sm shadow-md py-2 duration-300 ease-in-out ${
        isIconSidebar ? 'max-w-[270px]' : 'max-w-[50px]'
      }`}
    >
