...
export default function IncomeCard({ _type, amount, title, icon }) {
  return (
    <article className="flex items-center justify-between p-3 shadow-sm bg-white border-t border-t-orange-500 border border-gray-100 rounded-sm flex-grow flex-1">
